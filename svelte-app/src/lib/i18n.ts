...
const translations = {
	nl: {
		...
		wishlistOf: 'Wishlist van',
		wishlistEmptyOther: 'Deze persoon heeft nog geen items op de wishlist.',
	...
	en: {
		...
		wishlistEmptyOther: 'This person has no items on their wishlist yet.',
